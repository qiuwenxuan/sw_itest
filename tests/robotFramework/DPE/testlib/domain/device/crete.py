...
class crete_dpe (object):
    default_json = {
        "crete_iport_rx" : {
            "tbl_name": "crete_iport_rx",
            "overlay": 0,
            "source_port": 0,
            "opcode": 4,
            "default_action_index": 0,#默认到0口
            "meter_index": 0,
            "mep_bank": 0,
            "mep_reason": 0,
            "mirror_index": 0,
        ...
        "allowed_tpid_sel": 0,
        "allowed_pri": 0,
        "tpid_antispoof_ctl": 0,
        "pri_antispoof_ctl": 0,
        "meter_index": 0,
        "opcode_harp": 0
        },
        "crete_default_action" :{
            "tbl_name": "crete_default_action",
            "index": 0,
            "table": {
                "em_range_index0": 0,
                "em_range_index1": 0,
                ...
                "em_ver_group1": 0,
                "em_priority": 0,
                "em_statistic_enable": 0,
                "em_ct_enable": 0,
                "em_ecmp_entry_num": 0,
                "em_ver_group2": 0,
                "em_ver_group3": 0,
                "em_ex_result_index": 0,
                "em_tse_ext_result_len": 0,
                "em_opcode": 0,
                "em_mep_reason": 0,
                "em_mep_bank": 0,
                "em_update_group_index": 0,
                "em_telemetry_priority": 0,
                "em_set_tc_enable": 0,
                "em_set_tc_value": 0,
                "em_source_table": 0,
                "em_destination_valid": 0,
                "em_action_type": 0,
                "em_destination": 0,
                "em_profile_id": 0,
                "em_group_statistics_index": 0,
                "em_meter_num": {
                    "CRETE_METER_ENTRY_NUM": 0,
                    "CRETE_METER_INDEX0": 0,
                    "CRETE_METER_INDEX1": 0,
                    "CRETE_METER_INDEX2": 0,
                    "CRETE_METER_INDEX3": 0,
                    "CRETE_METER_INDEX4": 0,
                    "CRETE_METER_INDEX5": 0
                },
                "em_mirror_pri": 0,
                "em_mirror_index": 0,
                "em_mirror_meter_index": 0,
                "em_decapsulation": 0,
                "em_metadata_update": {
                    "metadata_bitmap": 0,
                    "metadata_updata0": {
                ...
                "em_replace_l4_dport": 0,
                "em_replace_l4_sport": 0,
                "em_replace_dipv4": 0,
                "em_replace_sipv4": 0,
                "em_ttl_update": {
                    "TTL_OP": 0,
                ...
                "em_tos_update": 0,
                "em_remove_outer_vlan": 0,
                "em_remove_inner_vlan": 0,
                "em_replace_smac": "0",
                "em_replace_dmac": "0",
                "em_update_field": [0, 0],
                "em_tunnel_encap_type": 0,
                "em_tunnel_encap_len": [
                    0,
                    {
                        "VX_FLAGS": 0,
        ...
        "crete_classify_hash" : {
            ...
            "set_tc_value": 0,
            "group_index": 0,
            "update_group_index": 0
        },
        "crete_classify_cam" : {
            "tbl_name": "crete_classify_cam",
            "pipe": 0,
            "priority": 0,
            "index": 0,
            "key_addr0": '0',
            "key_addr1": '0',
            "key_ethernet_type": 0,
            "key_outmost_vlan_valid": 0,
            "key_outmost_vlan_tpid": 0,
            "key_outmost_vlan_id": 0,
            "key_out2nd_vlan_valid": 0,
            "key_out2nd_vlan_tpid": 0,
            "key_out2nd_vlan_id": 0,
            "key_packet_type": 0,
            "key_packet_error_flag": 0,
            "key_packet_error_type": 0,
            "key_tcp_valid": 0,
            "key_tcp_flag": 0,
            "key_out2nd_tunnel_type": 0,
            "key_outmost_tunnel_type": 0,
            "key_harp_flag": 0,
            "key_tunnel_id_tunnel_context": 0,
            "key_group_index": 0,
            "mask_addr0": '0',
            "mask_addr1": '0',
            "mask_ethernet_type": 0,
            "mask_outmost_vlan_valid": 0,
            "mask_outmost_vlan_tpid": 0,
            "mask_outmost_vlan_id": 0,
            "mask_out2nd_vlan_valid": 0,
            "mask_out2nd_vlan_tpid": 0,
            "mask_out2nd_vlan_id": 0,
            "mask_packet_type": 0,
            "mask_packet_error_flag": 0,
            "mask_packet_error_type": 0,
            "mask_tcp_valid": 0,
            "mask_tcp_flag": 0,
            "mask_out2nd_tunnel_type": 0,
            "mask_outmost_tunnel_type": 0,
            "mask_harp_flag": 0,
            "mask_tunnel_id_tunnel_context": 0,
            "mask_group_index": 0,
            "opcode": 0,
            "tid": 0,
            "destination_valid": 0,
        ...
        "crete_profile" : {
            "tbl_name": "crete_profile",
            "pipe": 0,
            "priority": 0,
            "index": 0,
            "key_group_index": 0,
            "key_profile_id": 0,
            "key_innermost_l4dport": 0,
            "key_out3rd_l4_is_tcpudp": 0,
            "key_out3rd_l4_head_type": 0,
            "key_out3rd_l4_head_valid": 0,
            "key_out3rd_ip_flags": 0,
            "key_out3rd_l3_is_ip": 0,
            "key_out3rd_l3_head_type": 0,
            "key_out3rd_l3_head_valid": 0,
            "key_out3rd_vlan_tag2": 0,
            "key_out3rd_vlan_tag1": 0,
            "key_out3rd_mac_type": 0,
            "key_out3rd_l2_head_valid": 0,
            "key_out2nd_tunnel_flags": 0,
            "key_out2nd_tunnel_type": 0,
            "key_out2nd_tunnel_valid": 0,
            "key_out2nd_l4_is_tcpudp": 0,
            "key_out2nd_l4_head_type": 0,
            "key_out2nd_l4_head_valid": 0,
            "key_out2nd_ip_flags": 0,
            "key_out2nd_l3_is_ip": 0,
            "key_out2nd_l3_head_type": 0,
            "key_out2nd_l3_head_valid": 0,
            "key_out2nd_vlan_tag2": 0,
            "key_out2nd_vlan_tag1": 0,
            "key_out2nd_mac_type": 0,
            "key_out2nd_l2_head_valid": 0,
            "key_outmost_tunnel_flags": 0,
            "key_outmost_tunnel_type": 0,
            "key_outmost_tunnel_valid": 0,
            "key_outmost_l4_is_tcpudp": 0,
            "key_outmost_l4_head_type": 0,
            "key_outmost_l4_head_valid": 0,
            "key_outmost_ip_flags": 0,
            "key_outmost_l3_is_ip": 0,
            "key_outmost_l3_head_type": 0,
            "key_outmost_l3_head_valid": 0,
            "key_outmost_vlan_tag2": 0,
            "key_outmost_vlan_tag1": 0,
            "key_outmost_mac_type": 0,
            "key_outmost_l2_head_valid": 0,
            "mask_group_index": 0,
            "mask_profile_id": 0,
            "mask_innermost_l4dport": 0,
            "mask_out3rd_l4_is_tcpudp": 0,
            "mask_out3rd_l4_head_type": 0,
            "mask_out3rd_l4_head_valid": 0,
            "mask_out3rd_ip_flags": 0,
            "mask_out3rd_l3_is_ip": 0,
            "mask_out3rd_l3_head_type": 0,
            "mask_out3rd_l3_head_valid": 0,
            "mask_out3rd_vlan_tag2": 0,
            "mask_out3rd_vlan_tag1": 0,
            "mask_out3rd_mac_type": 0,
            "mask_out3rd_l2_head_valid": 0,
            "mask_out2nd_tunnel_flags": 0,
            "mask_out2nd_tunnel_type": 0,
            "mask_out2nd_tunnel_valid": 0,
            "mask_out2nd_l4_is_tcpudp": 0,
            "mask_out2nd_l4_head_type": 0,
            "mask_out2nd_l4_head_valid": 0,
            "mask_out2nd_ip_flags": 0,
            "mask_out2nd_l3_is_ip": 0,
            "mask_out2nd_l3_head_type": 0,
            "mask_out2nd_l3_head_valid": 0,
            "mask_out2nd_vlan_tag2": 0,
            "mask_out2nd_vlan_tag1": 0,
            "mask_out2nd_mac_type": 0,
            "mask_out2nd_l2_head_valid": 0,
            "mask_outmost_tunnel_flags": 0,
            "mask_outmost_tunnel_type": 0,
            "mask_outmost_tunnel_valid": 0,
            "mask_outmost_l4_is_tcpudp": 0,
            "mask_outmost_l4_head_type": 0,
            "mask_outmost_l4_head_valid": 0,
            "mask_outmost_ip_flags": 0,
            "mask_outmost_l3_is_ip": 0,
            "mask_outmost_l3_head_type": 0,
            "mask_outmost_l3_head_valid": 0,
            "mask_outmost_vlan_tag2": 0,
            "mask_outmost_vlan_tag1": 0,
            "mask_outmost_mac_type": 0,
            "mask_outmost_l2_head_valid": 0,
            "opcode": 0,
            "destination_valid": 0,
            "default_destination": 0,
            "default_action_tid": 0,
            "em_lookup_enable": 0,
            "wc_lookup_enable": 0,
            "em_key_mask_id": 0,
            "em_profile_id": 0,
        ...
        "em_key_template" : {
            ...
            "outmost_dmac": 0,
            "outmost_smac": 0,
            "outmost_outer_vlan_tpid": 0,
            "outmost_outer_vlan_pri": 0,
            "outmost_outer_vlan_de": 0,
            "outmost_outer_vlan_vid": 0,
            "outmost_inner_tpid": 0,
            "outmost_inner_vlan_pri": 0,
            "outmost_inner_vlan_de": 0,
            "outmost_inner_vlan_vid": 0,
            "outmost_eth_type": 0,
            "outmost_sip": 0,
            "outmost_dip": 0,
            "outmost_protocol": 0,
            ...
            "outmost_flow": 0,
            "outmost_fragment": 0,
            "outmost_extension_head_valid": 0,
            "outmost_sport_lo_icmp_code": 0,
            "outmost_sport_hi_icmp_type": 0,
            "outmost_dport_icmp_id": 0,
            "outmost_flags": 0,
            "outmost_tunnel_type": 0,
            "outmost_tunnel_id": 0,
            "outmost_tunnel_flags": 0,
            "out2nd_dmac": 0,
            "out2nd_smac": 0,
            "out2nd_outer_vlan_tpid": 0,
            "out2nd_outer_vlan_pri": 0,
            "out2nd_outer_vlan_de": 0,
            "out2nd_outer_vlan_vid": 0,
            "out2nd_inner_tpid": 0,
            "out2nd_inner_vlan_pri": 0,
            "out2nd_inner_vlan_de": 0,
            "out2nd_inner_vlan_vid": 0,
            "out2nd_eth_type": 0,
            "out2nd_sip": 0,
            "out2nd_dip": 0,
            "out2nd_protocol": 0,
            ...
            "out2nd_flow": 0,
            "out2nd_fragment": 0,
            "out2nd_extension_head_valid": 0,
            "out2nd_sport_lo_icmp_code": 0,
            "out2nd_sport_hi_icmp_type": 0,
            "out2nd_dport_icmp_id": 0,
            "out2nd_flags": 0,
            "out2nd_tunnel_type": 0,
            "out2nd_tunnel_id": 0,
            "out2nd_tunnel_flags": 0,
            "out3rd_smac": 0,
            "out3rd_dmac": 0,
            "out3rd_outer_vlan_tpid": 0,
            "out3rd_outer_vlan_pri": 0,
            "out3rd_outer_vlan_de": 0,
            "out3rd_outer_vlan_vid": 0,
            "out3rd_inner_tpid": 0,
            "out3rd_inner_vlan_pri": 0,
            "out3rd_inner_vlan_de": 0,
            "out3rd_inner_vlan_vid": 0,
            "out3rd_eth_type": 0,
            "out3rd_sip": 0,
            "out3rd_dip": 0,
            "out3rd_protocol": 0,
            ...
            "out3rd_flow": 0,
            "out3rd_fragment": 0,
            "out3rd_extension_head_valid": 0,
            "out3rd_sport_lo_icmp_code": 0,
            "out3rd_sport_hi_icmp_type": 0,
            "out3rd_dport_icmp_id": 0,
            "out3rd_flags": 0,
            "udf0_en": 0,
            "udf1_en": 0,
            "udf2_en": 0,
        ...
        'crete_vport_rx':
        {        
            "tbl_name": "crete_vport_rx",
            "index": 0,
            "opcode": 0,
            "profile_id": 0,
            "port_vlan_id": 0,
            "port_vlan_flag": 0,
            "port_untag_pass_flag": 0,
            "outer_vlan_filter_flag": 0,
            "outer_vlan_tpid_flag": 0,
            "outer_tpid_filter_flag": 0,
            "outer_vlan_tpid": 0,
            "inner_vlan_filter_flag":0,
            "inner_vlan_tpid_flag": 0,
            "inner_tpid_filter_flag": 0,
            "inner_vlan_tpid": 0,
            "save_inner_vlan": 0,
            "save_outer_vlan": 0,
            "pop_inner_vlan": 0,
            "pop_outer_vlan": 0,
            "mac_timestamp_valid": 0,
            "rx_set_meta2cqe": 0,
            "rdma_enable": 0,
            "mep_reason": 0,
            "mep_bank": 0
    ...
    def table_check(config,default_json,simplify=False):
        if 'group' in config:
            for i in config['group']:
                crete_dpe.table_check(i,default_json,simplify)
            return config
        ...
        if simplify:
            ...
            for k,v in default_json.items():
                ...
                config[k] = crete_dpe.value_check(k,config[k],v)
                if isinstance(v,dict):
                    config.setdefault(k,dict())
                    for k1,v1 in v.items():
                        config[k].setdefault(k1,v1)
                        config[k][k1] = crete_dpe.value_check(k1,config[k][k1],v1)
        return config

    @staticmethod
    def crete_config_check(config,simplify=False):
        if 'tbl_name' in config:
            k = config['tbl_name']
            v = config
            if k == "crete_iport_rx":
                config = crete_dpe.input_port_rx_check(v,simplify)
            elif k == "crete_default_action":
                config = crete_dpe.default_action_check(v,simplify)
            #elif k == "crete_classify_hash":
            #    config = crete_dpe.classify_hash_check(v,simplify)
            elif k == "crete_classify_cam":
                config = crete_dpe.classify_check(v,simplify)
            elif k == 'register':
                config = crete_dpe.register_check(v,simplify)
            elif k == 'profile':
                config = crete_dpe.profile_check(v,simplify)
            elif k == 'key_mask':
                config = crete_dpe.key_mask_check(v,simplify)
            elif k == 'key_template':
                config = crete_dpe.key_template_check(v,simplify)
            elif k == 'em_table':
                config = crete_dpe.em_check(v,simplify)
            elif k == 'source_mode1':
                config = crete_dpe.source_mode1_check(v,simplify)
            elif k == 'source_mode2':
                config = crete_dpe.source_mode2_check(v,simplify)
            elif k == 'tunnel_encap':
                config = crete_dpe.tunnel_encap_check(v,simplify)
            else :
                config = crete_dpe.table_common_check(v,k,simplify)
            return config

        for k,v in config.items():
            if k == "crete_iport_rx":
                config[k] = crete_dpe.input_port_rx_check(v,simplify)
            elif k == "crete_default_action":
                config[k] = crete_dpe.default_action_check(v,simplify)
            #elif k == "crete_classify_hash":
            #    config = crete_dpe.classify_hash_check(v,simplify)
            elif k == "crete_classify_cam":
                config[k] = crete_dpe.classify_check(v,simplify)
            elif k == 'register':
                config[k] = crete_dpe.register_check(v,simplify)
            elif k == 'profile':
                config[k] = crete_dpe.profile_check(v,simplify)
            elif k == 'key_mask':
                config[k] = crete_dpe.key_mask_check(v,simplify)
            elif k == 'key_template':
                config[k] = crete_dpe.key_template_check(v,simplify)
            elif k == 'em_table':
                config[k] = crete_dpe.em_check(v,simplify)
            elif k == 'source_mode1':
                config[k] = crete_dpe.source_mode1_check(v,simplify)
            elif k == 'source_mode2':
                config[k] = crete_dpe.source_mode2_check(v,simplify)
            elif k == 'tunnel_encap':
                config[k] = crete_dpe.tunnel_encap_check(v,simplify)
            else :
                config[k] = crete_dpe.table_common_check(k,v,simplify)
        return config

    @staticmethod
    def table_template_get(tablename=None):
        if tablename == None:
            default_json = copy.deepcopy(crete_dpe.default_json)
        else:
            if tablename not in crete_dpe.default_json:
                return None
            default_json = copy.deepcopy(crete_dpe.default_json[tablename])
        return default_json
    ...
    def table_common_check(tablename,config,simplify=False):
        if tablename not in crete_dpe.default_json:
            return config
        default_json = crete_dpe.default_json[tablename]
        config = crete_dpe.table_check(config,default_json,simplify)
        return config

    @staticmethod
    def input_port_rx_check(config,simplify=False):
        default_json = crete_dpe.default_json["crete_iport_rx"]
        config = crete_dpe.table_check(config,default_json,simplify)
        return config

    @staticmethod
    def default_action_check(config,simplify=False):
        default_json = crete_dpe.default_json["crete_default_action"]
        if 'table' in config:
            config["table"] = crete_dpe.createData(config["table"])
        config = crete_dpe.table_check(config,default_json,simplify)
        return config

    @staticmethod
    def classify_check(config,simplify=False):
        default_json = crete_dpe.default_json["crete_classify_cam"]
        config = crete_dpe.table_check(config,default_json,simplify)
        return config
    
    @staticmethod
    def profile_check(config,simplify=False):
        default_json = crete_dpe.default_json["profile"]
        config = crete_dpe.table_check(config,default_json,simplify)
        return config

    @staticmethod
    def register_check(config,simplify=False):
        default_json = crete_dpe.default_json["register"]
        config = crete_dpe.table_check(config,default_json,simplify)
        return config

    @staticmethod
    def key_mask_check(config,simplify=False):
        default_json = crete_dpe.default_json["key_mask"]
    ...
    def key_template_check(config,simplify=False):
        default_json = crete_dpe.default_json["key_template"]
        config = crete_dpe.table_check(config,default_json,simplify)
        return config
		
    @staticmethod
    def em_check(config,simplify=False):
        default_json = crete_dpe.default_json["em_table"]
        if isinstance(config['key'],dict):
            ...
            for k in info:
                info[k] = crete_dpe.value_check(k,info[k])
            config['key'] = crete_dpe.getEmKey(None,keytemp,keylen,info)[0]
        if 'table' in config:
            config["table"] = crete_dpe.createData(config["table"])
        config = crete_dpe.table_check(config,default_json,simplify)
        return config
    ...
    def source_mode1_check(config,simplify=False):
        default_json = crete_dpe.default_json["source_mode1"]
        config = crete_dpe.table_check(config,default_json,simplify)
        return config
    
    @staticmethod
    def source_mode2_check(config,simplify=False):
        default_json = crete_dpe.default_json["source_mode2"]
        config = crete_dpe.table_check(config,default_json,simplify)
        return config
 
    @staticmethod
    def tunnel_encap_check(config,simplify=False):
        default_json = crete_dpe.default_json["tunnel_encap"]
        config = crete_dpe.table_check(config,default_json,simplify)
        return config   
    ...
    def createData(config):
        ...
        for k,l,t in keylist:
            ...
            if "TOS_UPDATE" == k:
                ...
                if type(info) == dict:
                    tpid = crete_dpe.getvlantpid(info.get('tpid',0))
                ...
                config[k] = info[0]
                #组装封装表
                val = crete_dpe.createEncapData(info)
                if val != None:
                ...
                val = crete_dpe.value_check(k,info)     #小序
                ...
                if type(info) == list:
                    ...
                    if type(info[1]) == IP:
                        ...
                        dip = crete_dpe.value_check('ip',info[1].dst)
                ...
                config[k] = info[0]
                vlan = info[1]
                val = crete_dpe.createVtagVlanData(vlan)
                l = 24
        
                if vlan.type == 0x8100:
                    vlan1 = info[1].payload 
                    val += crete_dpe.createVtagVlanData(vlan1) 
                    l += 24  
            elif "L2_FLAG" == k:  
                if type(info) == list:
                    config[k] = info[0]
    ...
    def getPacketLong(pkt):
        ...
        name = crete_dpe.checkPacket(pkt)
        name = '.' + name.lower() + '.'
        #不能调用paserPacket
    ...
    def paserPacket(pkt):
        ...
        ret['tltype'] = None
        ret['tunnel_number'] = 0
        ot    = crete_dpe.paserPacketFirstLayer(pkt)
        for k,v in ot.items():
            ret['ot_'+k] = v
        ...
        ret['tunnel_number'] = 1
        ret['tl'] = ot['last']
        tl    = crete_dpe.paserPacketFirstLayer(ot['last'])
        for k,v in tl.items():
            ret['tl_'+k] = v
        ...
        ret['tunnel_number'] = 2
        ret['in'] = tl['last']
        inner = crete_dpe.paserPacketFirstLayer(tl['last'])
    ...
    def getPacketHeader(itype,pktlen=0,padlen=0):
        '''转换报文类型（非长名称）为 Packet , 默认不填充
           ...
           2、Eth.IP.UDP
        '''
        itype = crete_dpe.checkPacket(itype)
        if isinstance(itype,Packet):
            return itype
        
        its = crete_dpe.splitName(itype)
        pkt = None
    ...
    def getPacket(itype,pktlen=0,padlen=0):
        ...
        itype = crete_dpe.checkPacket(itype)
        longname = crete_dpe.getPacketLong(itype)
        if isinstance(itype,Packet):
            pkt = crete_dpe.getPacketHeader(itype,pktlen,padlen)
        else:
            pkt = crete_dpe.getPacketHeader(longname,pktlen,padlen)   
        info = crete_dpe.paserPacket(pkt)
    ...
    def getBasePkt(itype,pktlen=0):
        ...
        if itype not in pktdict:
            return crete_dpe.getPacket(itype,pktlen=128)
    ...
    def setClassifyByRuleList(info,ilist=list()):
        ...
        if 'ottype' in info and info['ottype'] != None:
            ottype,l = crete_dpe.getTypeid('tunnel',info['ottype'])
            
        if 'tltype' in info and info['tltype'] != None:
            tltype,l = crete_dpe.getTypeid('tunnel',info['tltype'])

        pktvalue = {
            #key
            "key_ethernet_type": 2048,
            "key_outmost_vlan_valid": 0,
            "key_outmost_vlan_tpid": 0,
            "key_outmost_vlan_id": 0,
            "key_out2nd_vlan_valid": 0,
            ...
            #mask
            "mask_ethernet_type": "0xFFFF",
            "mask_outmost_vlan_valid": 1,
            "mask_outmost_vlan_tpid": 0x7,
            "mask_outmost_vlan_id": (1<<12)-1,
            "mask_out2nd_vlan_valid": 1,
            "mask_out2nd_vlan_tpid": 0x7,
            "mask_out2nd_vlan_id": (1<<12)-1,
            "mask_packet_type": "0xF",
            "mask_packet_error_flag": 1,
            "mask_packet_error_type": 0x7,
            "mask_tcp_valid": 1,
            "mask_tcp_flag": (1<<12)-1,
            "mask_out2nd_tunnel_type": (1<<5)-1 if tltype != 0 else 0,
            "mask_outmost_tunnel_type": (1<<5)-1 if ottype != 0 else 0,
            "mask_harp_flag": 1,
            "mask_tunnel_id_tunnel_context": "0xFFFFFFFF",                                                   
        }
                  
        iinfo = crete_dpe.getClassifyIpktInfo(info)
        #根据配置设置表项
        for i in ilist:
            if i in iinfo:
                field = re.sub('ot_', '', i)
    ...
    def getClassifyIpktInfo(info):
        ...
        idict = {
                "ot_outmost_vlan_valid": 1 if 'ot_vlan' in info else 0,
                "ot_out2nd_vlan_valid": 1 if 'ot_vlan1' in info else 0,
                "ot_outmost_vlan_tpid": crete_dpe.getvlantpid(info['ot'][0].type) if 'ot_vlan' in info else 0,
                "ot_outmost_vlan_id": info['ot_vlan'].vlan if 'ot_vlan' in info else 0,
                "ot_out2nd_vlan_tpid": crete_dpe.getvlantpid(info['ot'][1].type) if 'ot_vlan1' in info else 0,
                "ot_out2nd_vlan_id": info['ot_vlan1'].vlan if 'ot_vlan1' in info else 0,
                "ot_ethernet_type": info['ot_l2proto'] if 'ot_l2proto' in info else 0,
                #"OT_TUNNEL_ID": info['ot_tunid'] if 'ot_tunid' in info else 0,
                "tl_outmost_vlan_valid": 1 if 'tl_vlan' in info else 0,
                "tl_out2nd_vlan_valid": 1 if 'tl_vlan1' in info else 0,
                "tl_outmost_vlan_tpid": crete_dpe.getvlantpid(info['tl'][0].type) if 'tl_vlan' in info else 0,
                "tl_outmost_vlan_id": info['tl_vlan'].vlan if 'tl_vlan' in info else 0,
                "tl_out2nd_vlan_tpid": crete_dpe.getvlantpid(info['tl'][1].type) if 'tl_vlan1' in info else 0,
                "tl_out2nd_vlan_id": info['tl_vlan1'].vlan if 'tl_vlan1' in info else 0,
                "tl_ethernet_type": info['tl_l2proto'] if 'tl_l2proto' in info else 0,
                #"TL_TUNNEL_ID": info['tl_tunid'] if 'tl_tunid' in info else 0, 
                "outmost_vlan_valid": 1 if 'vlan' in info else 0,
                "out2nd_vlan_valid": 1 if 'vlan1' in info else 0,
                "outmost_vlan_tpid": crete_dpe.getvlantpid(info['in'][0].type) if 'vlan' in info else 0,
                "outmost_vlan_id":info['vlan'].vlan if 'vlan' in info else 0,
                "out2nd_vlan_tpid": crete_dpe.getvlantpid(info['in'][1].type) if 'vlan1' in info else 0,
                "out2nd_vlan_id": info['vlan1'].vlan if 'vlan1' in info else 0,
                "ethernet_type": info['l2proto'] if 'l2proto' in info else 0, 
                "tcp_flag": info['l2proto'] if 'l2proto' in info else 0,   
                "tcp_valid": info['l2proto'] if 'l2proto' in info else 0,          
        }
    ...
    def setClassifyByPkt(config,info,layer,mode=-1,ilist=None):
        #设置Classify匹配的pkt条件              
        pkttmp = info[layer]
        if IP in pkttmp and mode in [0,1]: #dmac, sip, dip
            config["key_addr0"] = pkttmp[Ether].dst
            config["key_addr1"] = list()
            config["key_addr1"].append(pkttmp[IP].src)
            config["key_addr1"].append(pkttmp[IP].dst)            
            config["mask_addr0"] = "0xFFFFFFFFFFFF"
            config["mask_addr1"] = "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"
        elif IP in pkttmp and mode in [2,3]: #smac,sip,dip
            config["key_addr0"] = pkttmp[Ether].src
            config["key_addr1"] = list()
            config["key_addr1"].append(pkttmp[IP].src)
            config["key_addr1"].append(pkttmp[IP].dst)
            config["mask_addr0"] = "0xFFFFFFFFFFFF"
            config["mask_addr1"] = "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"
        elif IP in pkttmp and mode == 4: #dmac,smac
            config["key_addr0"] = pkttmp[Ether].dst
            config["key_addr1"] = pkttmp[Ether].src
            config["mask_addr0"] = "0xFFFFFFFFFFFF"
            config["mask_addr1"] = "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"
        elif IPv6 in pkttmp and mode == 0: #dmac dip
            config["key_addr0"] = pkttmp[Ether].dst
            config["key_addr1"] = pkttmp[IPv6].dst
            config["mask_addr0"] = "0xFFFFFFFFFFFF"
            config["mask_addr1"] = "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"
        elif IPv6 in pkttmp and mode == 1: #dmac sip
            config["key_addr0"] = pkttmp[Ether].dst
            config["key_addr1"] = pkttmp[IPv6].src
            config["mask_addr0"] = "0xFFFFFFFFFFFF"
            config["mask_addr1"] = "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"
        elif IPv6 in pkttmp and mode == 2: #smac dip
            config["key_addr0"] = pkttmp[Ether].src
            config["key_addr1"] = pkttmp[IPv6].dst      
            config["mask_addr0"] = "0xFFFFFFFFFFFF"
            config["mask_addr1"] = "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"            
        elif IPv6 in pkttmp and mode == 3: #smac sip
            config["key_addr0"] = pkttmp[Ether].src
            config["key_addr1"] = pkttmp[IPv6].src      
            config["mask_addr0"] = "0xFFFFFFFFFFFF"
            config["mask_addr1"] = "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"
        elif IPv6 in pkttmp and mode == 4: #dmac smac
            config["key_addr0"] = pkttmp[Ether].dst
            config["key_addr1"] = pkttmp[Ether].src
            config["mask_addr0"] = "0xFFFFFFFFFFFF"
            config["mask_addr1"] = "0xFFFFFFFFFFFF"  
        elif mode in [0,1,4]: #dmac smac
            config["key_addr0"] = pkttmp[Ether].dst
            config["key_addr1"] = pkttmp[Ether].src
            config["mask_addr0"] = "0xFFFFFFFFFFFF"
            config["mask_addr1"] = "0xFFFFFFFFFFFF"
        elif mode in [2,3]: #smac dmac
            config["key_addr0"] = pkttmp[Ether].src
            config["key_addr1"] = pkttmp[Ether].dst
            config["mask_addr0"] = "0xFFFFFFFFFFFF"
            config["mask_addr1"] = "0xFFFFFFFFFFFF"  
        ...
        #根据列表重新设置匹配项
        pktvalue = crete_dpe.setClassifyByRuleList(info,ilist)

        for i in ilist:
            field = re.sub('ot_', '', i)
            field = re.sub('tl_', '', field)
            if field in pktvalue:
                i = field
                config['key_' + i] = pktvalue['key' + i]
    ...
    def setProfileTemplate(profile=None,itype=None):
        ...
        '''
        itype = crete_dpe.getPacketLong(itype)
        ...
        default_json = {
            "key_group_index": 0, 
            "key_profile_id": 0,
            "mask_group_index": "0xFF",
            "mask_profile_id": "0xFF",
        }
        default_mask = {
            "mask_group_index": "0xFF",
            "mask_profile_id": "0xFF",
            "mask_innermost_l4dport": "0xFFFF",
            "mask_out3rd_l4_is_tcpudp": 1,
            "mask_out3rd_l4_head_type": "0xF",
            "mask_out3rd_l4_head_valid": 1,
            "mask_out3rd_ip_flags": "0x3FF",
            "mask_out3rd_l3_is_ip": 1,
            "mask_out3rd_l3_head_type": "0xF",
            "mask_out3rd_l3_head_valid": 1,
            "mask_out3rd_vlan_tag2": 1,
            "mask_out3rd_vlan_tag1": 1,
            "mask_out3rd_mac_type": 3,
            "mask_out3rd_l2_head_valid": 1,
            "mask_out2nd_tunnel_flags": "0xFF",
            "mask_out2nd_tunnel_type": "0xF",
            "mask_out2nd_tunnel_valid": 1,
            "mask_out2nd_l4_is_tcpudp": 1,
            "mask_out2nd_l4_head_type": "0xF",
            "mask_out2nd_l4_head_valid": 1,
            "mask_out2nd_ip_flags": "0x3FF",
            "mask_out2nd_l3_is_ip": 1,
            "mask_out2nd_l3_head_type": "0xF",
            "mask_out2nd_l3_head_valid": 1,
            "mask_out2nd_vlan_tag2": 1,
            "mask_out2nd_vlan_tag1": 1,
            "mask_out2nd_mac_type": 3,
            "mask_out2nd_l2_head_valid": 1,
            "mask_outmost_tunnel_flags": "0xFF",
            "mask_outmost_tunnel_type": "0xF",
            "mask_outmost_tunnel_valid": 1,
            "mask_outmost_l4_is_tcpudp": 1,
            "mask_outmost_l4_head_type": "0xF",
            "mask_outmost_l4_head_valid": 1,
            "mask_outmost_ip_flags": "0x3FF",
            "mask_outmost_l3_is_ip": 1,
            "mask_outmost_l3_head_type": "0xF",
            "mask_outmost_l3_head_valid": 1,
            "mask_outmost_vlan_tag2": 1,
            "mask_outmost_vlan_tag1": 1,
            "mask_outmost_mac_type": 3,
            "mask_outmost_l2_head_valid": 1,
        }

        if profile == None: profile = default_json

        info = crete_dpe.paserPacket(itype)
        ...
        if ot != None:
            ...
            ilist = ot.split('.')
            if ottype:
                profile["key_outmost_tunnel_valid"] = 1
                #需要设置寄存器，后面修改
                
                profile["key_outmost_tunnel_type"] = typeid['tunnel'][ottype]
                if ottype == 'vxlan' or ottype == 'vxlan-ali':
                    profile["key_outmost_tunnel_flags"] = 0x08 
                elif ottype == 'vxlan-gpe':
                    profile["key_outmost_tunnel_flags"] = 0x0c
                elif ottype == 'geneve':
                    profile["key_outmost_tunnel_flags"] = 0x0
                #elif ottype == 'gre':
            ...
            if 'l5p5' in ilist or t:
                if t : profile["PROFILE_OT_L5P5_HD_TYPE"] = typeid["l4"][t[0]]
                profile["PROFILE_OT_L5P5_HD_VALID"] = 1
            '''
            t = isin(ilist,typeid["l4"].keys())
            if 'l4' in ilist or t:
                if t[0] in ['tcp','udp']:profile["key_outmost_l4_is_tcp_udp"] = 1
                if t :profile["key_outmost_l4_header_type"] = typeid["l4"][t[0]]
                profile["key_outmost_l4_header_valid"] = 1
            '''
            t = isin(ilist,typeid["l3p5"].keys())
            if 'l3p5' in ilist:
                if t : profile["PROFILE_OT_L3P5_HD_TYPE"] = typeid["l3p5"][t[0]]
                profile["PROFILE_OT_L3P5_VALID"] = 1
            '''
            t = isin(ilist,typeid["l3"].keys())
            if 'l3' in ilist or t:
                if t :
                    if 'ipv4' in t[0] or 'ipv6' in t[0] : profile["key_outmost_l3_is_ip"] = 1
                    profile["key_outmost_l3_header_type"] = typeid["l3"][t[0]]
                profile["key_outmost_l3_header_valid"] = 1
                profile["key_outmost_ip_flags"] = 1                            #待修改
            '''
            t = isin(ilist,typeid["l2p5"].keys())
            if 'l2p5' in ilist or t:
                if 'mpls' in ilist : profile["PROFILE_OT_L2P5_SUBTYPE"] = 0  #标签层数
                if 'mpls' in ilist :
                    profile["PROFILE_OT_L2P5_HD_TYPE"] = typeid["l2p5"][t[0]]
                profile["PROFILE_OT_L2P5_HD_VALID"] = 1
            '''
            if '2vlan' in ilist:
                profile["key_outmost_vlan_tag2"] = 1
                profile["key_outmost_vlan_tag1"] = 1
            if 'vlan' in ilist:
                profile["key_outmost_vlan_tag1"] = 1
            if 'eth'in ilist or t:
                if t :
                    profile["key_outmost_macuc_bc_mc"] = typeid["l2"][t[0]]
                profile["key_outmost_l2_header_valid"] = 1
            if 'noeth' in ilist:
                profile["key_outmost_l2_header_valid"] = 0
        if tl != None:
            ilist = tl.split('.')
            ...
            ilist = tl.split('.')
            if tltype:
                profile["key_out2nd_tunnel_valid"] = 1
                #需要设置寄存器，后面修改
                if tltype == 'vxlan' or tltype == 'vxlan-ali':
                    profile["key_out2nd_tunnel_flags"] = 0x08 
                elif tltype == 'vxlan-gpe':
                    profile["key_out2nd_tunnel_flags"] = 0x0c
                elif tltype == 'geneve':
                    profile["key_out2nd_tunnel_flags"] = 0x0
                #elif tltype == 'gre':
                    #key["PROFILE_TL_TUNNEL_FLAGS"] = 0x30
                    #key["PROFILE_TL_TUNNEL_FLAGS"] = 0x0
                #else:
                    #key["PROFILE_TL_TUNNEL_FLAGS"] = 0
                profile["key_ut2nd_tunnel_type"] = typeid['tunnel'][tltype]
            '''
            t = isin(ilist,typeid["l5p5"].keys())
            if 'l5p5' in ilist or t:
                if t : profile["PROFILE_TL_L5P5_HD_TYPE"] = typeid["l4"][t[0]]
                profile["PROFILE_TL_L5P5_HD_VALID"] = 1
            '''
            t = isin(ilist,typeid["l4"].keys())
            if 'l4' in ilist or t:
                if t and (t[0] in ['tcp','udp']):profile["key_out2nd_l4_is_tcp_udp"] = 1
                if t :profile["key_out2nd_l4_header_type"] = typeid["l4"][t[0]]
                profile["key_out2nd_l4_header_valid"] = 1
            '''
            t = isin(ilist,typeid["l3p5"].keys())
            if 'l3p5' in ilist:
                if t : profile["PROFILE_TL_L3P5_HD_TYPE"] = typeid["l3p5"][t[0]]
                profile["PROFILE_TL_L3P5_VALID"] = 1
            '''
            t = isin(ilist,typeid["l3"].keys())
            if 'l3' in ilist or t:
                if 'ip' in t : profile["key_out2nd_l3_is_ip"] = 1
                if t :
                    profile["key_out2nd_l3_header_type"] = typeid["l3"][t[0]]
                profile["key_out2nd_l3_header_valid"] = 1
                profile["key_out2nd_ip_flags"] = 1                            #待修改
            '''
            t = isin(ilist,typeid["l2p5"].keys())
            if 'l2p5' in ilist or t:
                if 'mpls' in ilist : profile["PROFILE_TL_L2P5_SUBTYPE"] = 0  #标签层数
                if 'mpls' in ilist :
                    profile["PROFILE_TL_L2P5_HD_TYPE"] = typeid["l2p5"][t[0]]
                profile["PROFILE_TL_L2P5_HD_VALID"] = 1
            '''
            if '2vlan' in ilist:
                profile["key_out2nd_vlan_tag2"] = 1
                profile["key_out2nd_vlan_tag1"] = 1
            if 'vlan' in ilist:
                profile["key_out2nd_vlan_tag1"] = 1
            if 'eth'in ilist or t:
                if t :
                    profile["key_out2nd_macuc_bc_mc"] = typeid["l2"][t[0]]
                profile["key_out2nd_l2_header_valid"] = 1
            if 'noeth' in ilist:
                profile["key_out2nd_l2_header_valid"] = 0
        if inner != None:
            ilist = inner.split('.')
            t = isin(ilist,typeid["l4"].keys())
            if 'l4' in ilist or t:
                if t and (t[0] in ['tcp','udp']):profile["key_out3rd_l4_is_tcp_udp"] = 1
                if t :profile["key_out3rd_l4_header_type"] = typeid["l4"][t[0]]
                profile["key_out3rd_l4_header_valid"] = 1
                profile["key_innermost_l4_destport"] = 1              #待修改
            '''
            t = isin(ilist,typeid["l3p5"].keys())
            if 'l3p5' in ilist:
                if t : profile["PROFILE_L3P5_HD_TYPE"] = typeid["l3p5"][t[0]]
                profile["PROFILE_L3P5_VALID"] = 1
            t = isin(ilist,typeid["l3"].keys())
            '''
            if 'l3' in ilist or t:
                if 'ip' in t : profile["key_out3rd_l3_is_ip"] = 1
                if t :
                    profile["key_out3rd_l3_header_type"] = typeid["l3"][t[0]]
                profile["key_out3rd_l3_header_valid"] = 1
                profile["key_out3rd_ip_flags"] = 1                #待修改
            '''
            t = isin(ilist,typeid["l2p5"].keys())
            if 'l2p5' in ilist or t:
                if 'mpls' in ilist : profile["PROFILE_L2P5_SUBTYPE"] = 0  #标签层数
                if t :
                    profile["PROFILE_L2P5_HD_TYPE"] = typeid["l2p5"][t[0]]
                profile["PROFILE_L2P5_HD_VALID"] = 1
            '''
            if '2vlan' in ilist:
                profile["key_out3rd_vlan_tag2"] = 1
                profile["key_out3rd_vlan_tag1"] = 1
            if 'vlan' in ilist:
                profile["key_out3rd_vlan_tag1"] = 1
            t = isin(ilist,typeid["l2"].keys())
            if 'eth'in ilist or t:
                if t :
                    profile["key_out3rd_macuc_bc_mc"] = typeid["l2"][t[0]]
                profile["key_out3rd_l2_header_valid"] = 1
            if 'noeth' in ilist:
                profile["key_out3rd_l2_header_valid"] = 0
        for i in profile.keys():
            if i.startwith('key_'):
                i = re.sub('key_','',i)
                if ('mask_' + i) in profile : continue
                profile['mask_' + i] = default_mask['mask_' + i]
    ...
    def getKeyTemplateInfo():
        ...
        setkey(None,None,"profile_id",1)
        setkey(None,None,"group_index",1)
        setkey(None,None,"vport_id_vport",1)        
        setkey(None,None,"mac_port_enable",1)
        setkey(None,None,"meta_data",10)    #?待修改
        setkey('ot_eth','dst',"outmost_dmac",48)
        setkey('ot_eth','src',"outmost_smac",48)
        setkey('ot_eth','type',"outmost_outer_vlan_tpid",3)
        setkey('ot_vlan','prio',"outmost_outer_vlan_pri",3)
        setkey('ot_vlan','id',"outmost_outer_vlan_de",1)
        setkey('ot_vlan','vlan',"outmost_outer_vlan_vid",12)
        setkey('ot_vlan','type',"outmost_inner_vlan_tpid",3)
        setkey('ot_vlan1','prio',"outmost_inner_vlan_pri",3)
        setkey('ot_vlan1','id',"outmost_inner_vlan_de",1)
        setkey('ot_vlan1','vlan',"outmost_inner_vlan_vid",12)
        setkey('ot_l2proto',None,"outmost_eth_type",16)
        setkey('ot_l3','src',"outmost_sip",32)
        setkey('ot_l3','dst',"outmost_dip",32)
        setkey('ot_l3proto',None,"outmost_protocol",8)
        setkey('ot_l3ttl',None,"outmost_ttl",8)
        setkey('ot_l3tos',None,"outmost_tos",8)
        setkey('ot_l3flow',None,"outmost_flow",20)
        setkey('ot_ipv4','flags',"outmost_fragment",1)
        setkey('ot_ipv6ext','xxx',"outmost_extension_header_valid",1)
        setkey('ot_l4sport1',None,"outmost_sport_lo_icmp_code",8)   #待修改
        setkey('ot_l4sport2',None,"outmost_sport_hi_icmp_type",8)
        setkey('ot_l4dport',None,"outmost_dport_icmp_id",16)
        setkey('ot_l4flag',None,"outmost_flags",9)
        setkey('ot_tuntype',None,"outmost_tunneltype",5)
        setkey('ot_tunid',None,"outmost_vni_tunnel_id",32)
        setkey('ot_x','xxx',"outmost_tunnel_flags",8)
        '''
        ...
        '''
        setkey('tl_eth','dst',"out2nd_dmac",48)
        setkey('tl_eth','src',"out2nd_smac",48)
        setkey('tl_eth','type',"out2nd_outer_vlan_tpid",3)
        setkey('tl_vlan','prio',"out2nd_outer_vlan_pri",3)
        setkey('tl_vlan','id',"out2nd_outer_vlan_de",1)
        setkey('tl_vlan','vlan',"out2nd_outer_vlan_vid",12)
        setkey('tl_vlan','type',"out2nd_inner_vlan_tpid",3)
        setkey('tl_vlan1','prio',"out2nd_inner_vlan_pri",3)
        setkey('tl_vlan1','id',"out2nd_inner_vlan_de",1)
        setkey('tl_vlan1','vlan',"out2nd_inner_vlan_vid",12)
        setkey('tl_l2proto',None,"out2nd_eth_type",16)
        setkey('tl_l3','src',"out2nd_sip",32)
        setkey('tl_l3','dst',"out2nd_dip",32)
        setkey('tl_l3proto',None,"out2nd_protocol",8)
        setkey('tl_l3ttl',None,"out2nd_ttl",8)
        setkey('tl_l3tos',None,"out2nd_tos",8)
        setkey('tl_l3flow',None,"out2nd_flow",20)
        setkey('tl_ipv4','flags',"out2nd_fragment",1)
        setkey('tl_ipv6ext',None,"out2nd_extension_header_valid",1)
        setkey('tl_l4sport1',None,"out2nd_sport_lo_icmp_code",8)
        setkey('tl_l4sport2',None,"out2nd_sport_hi_icmp_type",8)
        setkey('tl_l4dport',None,"out2nd_dport_icmp_id",16)
        setkey('tl_l4flag',None,"out2nd_flags",9)
        setkey('tl_tuntype',None,"out2nd_tunneltype",5)
        setkey('tl_tunid',None,"out2nd_vni_tunnel_id",32)
        setkey('tl_x','xxx',"out2nd_tunnel_flags",8)
        '''
        ...
        '''
        setkey('eth','dst',"out3rd_dmac",48)
        setkey('eth','src',"out3rd_smac",48)
        setkey('eth','type',"out3rd_outer_vlan_tpid",3)
        setkey('vlan','prio',"outer_vlan_pri",3)
        setkey('vlan','id',"outer_vlan_de",1)
        setkey('vlan','vlan',"outer_vlan_vid",12)
        setkey('vlan','type',"inner_vlan_tpid",3)
        setkey('vlan1','prio',"inner_vlan_pri",3)
        setkey('vlan1','id',"inner_vlan_de",1)
        setkey('vlan1','vlan',"inner_vlan_vid",12)
        setkey('l2proto',None,"out3rd_eth_type",16)
        setkey('l3','src',"out3rd_sip",32)
        setkey('l3','dst',"out3rd_dip",32)
        setkey('l3proto',None,"out3rd_protocol",8)
        setkey('l3ttl',None,"out3rd_ttl",8)
        setkey('l3tos',None,"out3rd_tos",8)
        setkey('l3flow',None,"out3rd_flow",20)
        setkey('ipv4',"flags","out3rd_fragment",1)
        setkey('ipv6ext',None,"out3rd_extension_header_valid",1)
        setkey('l4sport1',None,"out3rd_sport_lo_icmp_code",8)
        setkey('l4sport2',None,"out3rd_sport_hi_icmp_type",8)
        setkey('l4dport',None,"out3rd_dport_icmp_id",16)
        setkey('l4flag',None,"out3rd_flags",9)
        setkey('xxxx','xxx',"udf0_en",1)
        setkey('xxxx','xxx',"udf1_en",1)
        setkey('xxxx','xxx',"udf2_en",1)
        setkey('xxxx','xxx',"udf3_en",1)
        setkey('xxxx','xxx',"udf4_en",1)
        setkey('xxxx','xxx',"udf5_en",1)
        setkey('xxxx','xxx',"udf6_en",1)
        setkey('xxxx','xxx',"udf0_sel",16)
        setkey('xxxx','xxx',"udf1_sel",16)
        setkey('xxxx','xxx',"udf2_sel",16)
        setkey('xxxx','xxx',"udf3_sel",16)
        setkey('xxxx','xxx',"udf4_sel",16)
        setkey('xxxx','xxx',"udf5_sel",16)
        setkey('xxxx','xxx',"udf6_sel",16)
        setkey('xxxx','xxx',"udf7_sel",16)
        setkey('xxxx','xxx',"rangecheck_type0",4)
        setkey('xxxx','xxx',"rangecheck_type1",4)
        setkey('xxxx','xxx',"udf7_en",1)
    ...
    def getEmKey(pkt,template,iemkeypara=None,config=dict()):
        ...
        def setkey(x,y,k,ilen):
            ...
            if isinstance(info[x],Packet):
                ...
                if 'VLAN_TPID' in k : ibyte = crete_dpe.getvlantpid(val.type)
            else:
                ibyte = val
                if 'TUNNEL_TYPE' in k: ibyte,l = crete_dpe.getTypeid('tunnel',val)
                
            if ilen > 0 : l = ilen
            emkey.append((ibyte,l,k))

        templateinfo = crete_dpe.getKeyTemplateInfo()
    ...
    def getKeyMask(itype=None,pkt=None):
        ...
        specmask = False
        if '(' in itype :
            idict = crete_dpe.tansStrToDict(itype)
    ...
    def setKeyTemplate(config=None,itype=None):
        ...
        if not isinstance(itype,Packet):
                ...
                if v != None:
                    if 'mask' not in v:
                        if 'KEY_TEMPLATE_'+k in ['KEY_TEMPLATE_RANGE_CHECK_TYPE0','KEY_TEMPLATE_RANGE_CHECK_TYPE1']:
                            ...
                            crete_dpe.transKeyTemplateStrToV('range_check',v['type'])
                if k.endswith("SPORT"):
            ...
            '''
        #处理报文格式
        pkt    = crete_dpe.getPacketHeader(itype)
        info = crete_dpe.paserPacket(pkt)
        def setkey(x1,y1,z1):
    ...
    def createProfileTemplate(groupid,profileid,itype):
        ...
        return crete_dpe.setProfileTemplate(profile,itype)
    ...
    def getEmActionUpdateField(config=None,info=None, type='dst',regconf=None,mask_template_id=15):       
        ...
        if type == 'src' and config['src'] and config['src']['src_mode'] == 'data':
            ...
            crete_dpe.setEmActionUpdateFieldReg(regconf,mask,\
        ...
        #域段
            ...
            layer_sel = crete_dpe.getEmActionTypeid('updfield_layer', layer)
            ...
            fieldoffset = crete_dpe.getEmActionTypeid('updfield_offset', layeroffset)
            fieldoffset = fieldoffset[field]
            
            #用户配置的相对于字段的便宜
            valoffset = int(config[type].get('offset','0'))
            if valoffset != 0: #还有偏移，掩掉该bit位
                modmask = crete_dpe.getMaskByOffset(valoffset)
                if type == 'src':
            ...
            if width % 4 !=0 :
                ...
                use_mask = 1
                crete_dpe.setEmActionUpdateFieldReg(regconf,fieldlenmask,\
            ...
            op_code = crete_dpe.getEmActionTypeid('updfield_opcode',config.get('opcode','set'))
    ...
    def getEmActionTunlEncapValue(config=None):
        type = config['type']
        #tunnel = crete_dpe.getPacket(type)
        tunnel = None
        if type =='vxlan':
            ...
            #proto = crete_dpe.getEmActionTypeid('tunlproto', nextproto)
            #tunnel.proto= proto
    ...
    def getEmActionVlanPrio(k = None, config=None,layer=None,info=None):
        ...
        #设置默认值            
        crete_dpe.getEmActionVlan(config)
    ...
    def getEmActionVtagType(config=None,layer=None,info=None):
        ...
        if 'add' in conf and conf['add'] == 1:
            conf1 = crete_dpe.getEmActionVlan(conf)
        elif 'add' in conf and conf['add'] == 2:
            conf1 = crete_dpe.getEmActionVlan(conf)
            conf2 = crete_dpe.getEmActionVlan(conf)
    ...
    def getDefaultActionPacket(pkt,config,regconf=None,layer="ot"):
        ...
        #defaultInfo = crete_dpe.getDefaultEmActionInfo()
        p = pkt.copy()
        info = crete_dpe.paserPacket(p)
        for k,v in config.items():
            if type(v) != dict:
                v = crete_dpe.value_check(k,v)
            if layer+'l2' in info:
                p2 = info[layer+'l2']
            if layer+'l3' in info:
                p3 = info[layer+'l3']
            ...
            if "REPLACE_L4_DPORT" == k and type(p4) in [UDP,TCP,SCTP]:
                ...
                p3.dst = crete_dpe.int2ipv62(v)
            elif "REPLACE_SIPV6" == k and type(p3) in [IPv6]:
                p3.src = crete_dpe.int2ipv62(v)
                ...
                if type(v) == dict:
                    chkpri = crete_dpe.getEmActionVlanPrio(k,v,layer,info) #替换后的pri
                    #tpid = crete_dpe.getvlantpid(v['tpid'])
                ...
                data = crete_dpe.getEmActionUpdateField(v, info,'src',regconf,upd_field_mask_num)
                config[k].append(data)
                #upd_field_mask_num = upd_field_mask_num - 1
                data = crete_dpe.getEmActionUpdateField(v, info,'dst',regconf,upd_field_mask_num)
                crete_dpe.setEmActionUpdateFieldReg(regconf, data, PIPE_GRP_CSR_UPDATE_FIELD_CFG_01_REG)
                
            elif "TUNNEL_ENCAP_TYPE" == k:
                t = v.get('type','None')
                typev = crete_dpe.getEmActionTypeid('tunlencap',t,0)
                tunnel = crete_dpe.getEmActionTunlEncapValue(v)           
                config[k] = list()
                ...
                t = v.get('type','ipv4')
                itype = crete_dpe.getEmActionTypeid('l3encap',t)
                ...
                p = ot_l3/p
                tmp = copy.deepcopy(p)
                tmpinfo =  crete_dpe.paserPacket(tmp)
                ...
                vtag = crete_dpe.getEmActionVtagType(v, layer, info)
                ...
                ilayer = v.get('layer','')
                v = crete_dpe.getEmActionTypeid('tunldecap',ilayer)
                config[k] = v
                p = info[ilayer]
            #重新解析报文
            info = crete_dpe.paserPacket(p)
    ...
    def setDefaultAction(config,action):
        ...
        if "table" in config:
            conf = config["table"]
        actiondict = crete_dpe.tansStrToDict(action)
        ...
        for k,v in actiondict.items():
            if "UPDATE_FIELD" == k:
                v['src'] = crete_dpe.tansStrToDict(v['src'])
                v['dst'] = crete_dpe.tansStrToDict(v['dst'])
            if v != None :
                conf[k] = v
                continue
    ...
    def setTunnelEncapCfgTable(tunnel_encap = None,action = None):
        ...
        for k,v in actiondict.items():
            if "TUNNEL_ENCAP_TYPE"== k:
                typev = crete_dpe.getEmActionTypeid('tunlencap',v['type'],0)
...
if __name__ == '__main__':
    ...
    #c = crete_dpe.str_to_hex('0xffffffff')
    pkt = Ether(src='11:12:13:14:15:16',dst='21:22:23:24:25:26')/IP(src='1.2.3.4',dst="5.6.7.8",flags=1)/UDP()
    c = crete_dpe.getDefaultActionPacket(pkt,config)
    c = crete_dpe.createData({
    ...
    c = crete_dpe.getPacketLong(Ether(src='11:12:13:14:15:16',dst='21:22:23:24:25:26')/IP(src='1.2.3.4',dst="5.6.7.8",flags=1)/UDP())
    ...
    pkt = Ether(src='11:12:13:14:15:16',dst='21:22:23:24:25:26')/IP(src='1.2.3.4',dst="5.6.7.8",flags=1)/UDP()
    #template = crete_dpe.setKeyTemplate(template,pkt)
    template = crete_dpe.setKeyTemplate(template,"OT_L2_SMAC,OT_L2_DMAC,OT_L3_SIP,OT_L3_DIP,OT_L3_FRAG")
    ikey,ilen  = crete_dpe.getEmKey(pkt,template)
    if ikey[5] != 0x1 or ilen != 161 :raise AssertionError("Error")

    imask = crete_dpe.getKeyMask("OT_L2_SMAC(0xFFFF00000000),OT_L2_DMAC(0b1111),OT_L3_SIP(8),OT_L3_DIP,OT_L3_FRAG",pkt)
    ...
    #template = crete_dpe.setKeyTemplate(template,pkt)
    template = crete_dpe.setKeyTemplate(template,"OT_L2_SMAC,OT_L3_SIP,OT_L3_FRAG,OT_TUNNEL_ID,OT_TUNNEL_TYPE")
    ikey,ilen  = crete_dpe.getEmKey(pkt,template)
    if ikey[0:4] != [0x13141516,0x07081112,0xffc30506,0x3] or ilen != 118 :raise AssertionError("Error")

    c = crete_dpe.getPacket("eth.ipv4(chksum=1).udp.raw(load=10*'a')")
    if c[IP].chksum != 1 :raise AssertionError("Error")
    ret = crete_dpe.paserPacket('eth.ipv4.udp.vxlan.eth.ipv4.udp.vxlan.eth.ipv4.udp')
    if ret['in'] != 'eth.ipv4.udp':raise AssertionError("Error")
    ret = crete_dpe.paserPacket('eth.ipv4.udp.vxlan.eth.ipv4.udp')
    if ret['tl'] != 'eth.ipv4.udp':raise AssertionError("Error")
    ret = crete_dpe.paserPacket('eth.ipv4.udp')
    if ret['ot'] != 'eth.ipv4.udp':raise AssertionError("Error")
    ret = crete_dpe.paserPacket(Ether()/IP()/UDP())
    c = crete_dpe.getPacket("Ether/IP/UDP/(10*'a')")
    if type(c.lastlayer()) != Raw :raise AssertionError("Error")
    c = crete_dpe.getPacketLong(Ether()/IP()/UDP())
    if c != 'eth.ipv4.udp':raise AssertionError("Error")
    c = crete_dpe.getPacketLong('ipv4.udp.vxlan.vxlan.eth.ipv4.udp')
    if c != 'eth.ipv4.udp.vxlan.eth.ipv4.udp.vxlan.eth.ipv4.udp':raise AssertionError("Error")
    c = crete_dpe.getPacketLong('vxlan.vxlan.eth.ipv4.udp')
    if c != 'eth.ipv4.udp.vxlan.eth.ipv4.udp.vxlan.eth.ipv4.udp':raise AssertionError("Error")
    c = crete_dpe.getPacketLong('vxlan.vxlan.')
    if c != 'eth.ipv4.udp.vxlan.eth.ipv4.udp.vxlan.eth.ipv4.udp':raise AssertionError("Error")
    pktlist = {
            'eth.ipv4'        : 'eth.ipv4',
    ...
    c = crete_dpe.getPacketHeader('noeth')
    wrpcap("d:\\a.pcap",c)
    for k,v in pktlist.items():
        pkt = crete_dpe.getPacket(v,padlen=10)
        print("%s:%s"%(v,pkt.summary()))
        wrpcap("d:\\a.pcap",pkt,append=True)
        pkt1 = crete_dpe.getBasePkt(k)
